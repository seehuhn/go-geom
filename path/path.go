...
// Contour iterates over individual segments.
...
type Contour iter.Seq2[Command, []Point]

// Compound represents a path that consists of multiple contours.
type Compound interface {
	Contours() iter.Seq[Contour]
}

// ToCubic converts all quadratic segments in the contour to cubic segments.
...
func ToCubic(c Contour) Contour {
