...
### Added
- `rect.Rect.Transform` maps a rectangle through an affine
  `matrix.Matrix` and returns the axis-aligned bounding box of the
  result.
...
No source changes; re-tagged for the v0.7.2 Quire release.
